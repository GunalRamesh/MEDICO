...
public class prescription extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement ps = (PreparedStatement) con.prepareStatement("insert into prescription values(?,?,?,?)");
...
out.println("<br> ");
				...
				out.println("<center><h2 align=centere>Thank you "+Treatment+", you have created an account.</h2><br></center>");
